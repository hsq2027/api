...
-keep class com.ldrobot.utils.bean** {*;}
-keep class com.ldrobot.utils.http** {
    public *;
}
-keep class com.ldrobot.utils.http.HttpRequest {*;}
-keep class com.ldrobot.utils.http.HttpResponse {*;}
-keep class com.ldrobot.utils.util** {
    public *;
}
-keep class com.ldrobot.utils.BuildConfig {*;}
